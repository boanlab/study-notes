...
1.  `배열`
    ...
    - 저장하는 순서에 따른 종류
        ...
        - 행우선 순서 행렬
            ...
            ![ds_5](images/ds_5.png)
            
            - 행의 원소 순서대로 데이터 저장
    
    ## 희소 행렬(Sparse Matrix)
    
    ![ds_6](images/ds_6.png)
    ...
    2. `스택`
        ...
        - 동작 과정
            ...
            ![ds_13](images/ds_13.png)
            
    1. `큐`
        
        ### 큐란?
        
        ![ds_14](images/ds_14.png)
...
2. `그래프`
    ...
    - DFS(Depth First Search)
        ...
        <img src="images/ds_24.jpeg" width="521" height="215">
        <!-- ![ds_24](../src/ds_24.jpeg) -->
        
    - BFS(Breadth First Search)
        
        ![ds_25](images/ds_25.png)
