...
## 통신 매체와 데이터 링크
- 컴퓨터를 연결하는 케이블로는 트위스트 페어 케이블, 광섬유 케이블, 동축 케이블, 시리얼 케이블 등 사용하는 데이터 링크의 종류에 따라 케이블의 종류가 달라진다.
## 네트워크 인터페이스
- 컴퓨터를 네트워크에 연결하기 위하 장치
## 리피터
- 네트워크를 물리층에서 연장하는 장치
## 브리지/레이어 2 스위치
- 네트워크를 데이터 링크층에서 연장하는 장치
## 라우터/레이어 3 스위치
- 네트워크층에 의해 패킷을 전송하는 장치
## 레이어 4-7 스위치
